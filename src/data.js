...
export const PORTFOLIO = {
  ...
  projects: [
    ...
    {
      title: "FitFindr",
      sub: "Multi-Tool AI Agent · Secondhand Fashion",
      icon: "spark",
      status: "live",
      statusLabel: "Live Demo",
      desc: "Multi-tool AI agent for finding secondhand fashion and styling it. Uses a planning loop with one real decision point — not a fixed pipeline — across three tools (search, outfit suggestion, shareable caption), each absorbing its own failure modes to guarantee a useful response.",
  ...
  experience: [
    {
      ...
      bullets: [
        "Will analyze vendor contract utilization and performance trends to identify opportunities for operational improvement and cost efficiency across the supplier management portfolio.",
        "Will build <b>Excel</b> dashboards and <b>Power BI</b> reporting tools to track expenditures, service levels, and compliance activity against vendor contracts.",
        "Will support data reconciliation between vendor reports and internal systems, and contribute to documentation for contract reporting best practices.",
      ],
    },
    {
      ...
      bullets: [
        "Partnered with operations staff to scope and prioritize automation projects, then shipped <b>Copilot Studio</b> and <b>Power Automate</b> workflows that cut <b>8+ hours</b> of weekly manual work on meeting prep and mentorship matching.",
        ...
        "Analyzed operational processes to identify where AI automation was and wasn't appropriate, then delivered recommendations to senior leadership that drove a <b>25% improvement</b> in team efficiency.",
        "Ran small-group walkthroughs so non-technical staff could maintain and modify AI workflows after handoff, writing runbooks and troubleshooting guides to ensure tools kept running independently.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Mentored Team Purple in designing a Queue Management App for Seniors, guiding them from problem identification through user-centered design and a final presentation at the live <b>Tech Showcase</b>.",
        "Balanced technical guidance with empathy and encouragement, helping students navigate ethical implications of building technology for seniors and fostering a collaborative team culture.",
      ],
    },
    {
      when: "Mar 2025 — May 2026", mode: "Staten Island, NY · Part-time",
      role: "Student Office Assistant", org: "Center for Global Engagement · CUNY CSI",
      bullets: [
        "Served as a point of contact for the <b>English Language Institute</b> and Study Abroad office, responding to student and prospective student inquiries by phone, email, WhatsApp, and in person.",
        "Maintained and updated the ELI student database, tracking inquiries, applications, and enrollment status to support accurate reporting across the Center for Global Engagement.",
        ...
        "Co-staffed the <b>Spring 2026 Study Abroad Fair</b>, engaging 100+ student attendees, and supported logistics for ELI events and graduation ceremonies.",
      ],
    },
    {
      ...
      bullets: [
        "Mentored an NYC special education CS classroom at P721Q JFK Jr. School through the <b>AI League</b> program, sharing career experience and providing feedback on student app prototypes and product pitches.",
        "Served as project reviewer for the <b>Emoti-Con NYC</b> Youth Tech Expo, evaluating 10 student group projects across health, civic tech, and community categories from NYC middle and high schools.",
      ],
    },
  ],
